...
def main():
    ...
    print("=" * 50)
    print("MCP Server Bailian Video Synthesis 发布脚本")
    ...
    try:
        ...
        if args.test_pypi:
            print("测试安装命令:")
            print("pip install --index-url https://test.pypi.org/simple/ mcp-server-bailian-video-synthesis")
        else:
            print("安装命令:")
            print("pip install mcp-server-bailian-video-synthesis")
